...
Agent `0.10.0` ежедневно после 06:00 требует ввести логин сотрудника и четырёхзначный пароль. ЛКМ и ПКМ по значку в tray открывают меню с ручной сменой монтажёра. Порядок работы на общих ПК и безопасное обновление уже установленного `0.9.1` описаны в [OPERATOR_SELECTION.md](OPERATOR_SELECTION.md).
