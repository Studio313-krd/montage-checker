...
Agent `0.9.1` ежедневно после 06:00 требует выбрать сотрудника и подтвердить четырёхзначный PIN. ЛКМ и ПКМ по значку в tray открывают меню с ручной сменой монтажёра. Порядок работы на общих ПК и безопасное обновление уже установленного `0.8.0` описаны в [OPERATOR_SELECTION.md](OPERATOR_SELECTION.md).
